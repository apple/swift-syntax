...
public struct KeyPathComponentSyntax: SyntaxProtocol, SyntaxHashable, _LeafSyntaxNodeProtocol {
  ...
  public init(
    ...
    self = withExtendedLifetime((SyntaxArena(), (
            ...
            Syntax(period), 
            Syntax(unexpectedBetweenPeriodAndComponent), 
            Syntax(component), 
            Syntax(unexpectedAfterComponent)
          ))) { (arena, _) in
...
public struct KeyPathExprSyntax: ExprSyntaxProtocol, SyntaxHashable, _LeafExprSyntaxNodeProtocol {
  ...
  public init(
    ...
    self = withExtendedLifetime((SyntaxArena(), (
            ...
            Syntax(backslash), 
            Syntax(unexpectedBetweenBackslashAndRoot), 
            Syntax(root), 
            Syntax(unexpectedBetweenRootAndComponents), 
            Syntax(components), 
...
public struct KeyPathOptionalComponentSyntax: SyntaxProtocol, SyntaxHashable, _LeafSyntaxNodeProtocol {
  ...
  public init(
    ...
    // Extend the lifetime of all parameters so their arenas don't get destroyed
    // before they can be added as children of the new arena.
    self = withExtendedLifetime((SyntaxArena(), (Syntax(unexpectedBeforeQuestionOrExclamationMark), Syntax(questionOrExclamationMark), Syntax(unexpectedAfterQuestionOrExclamationMark)))) { (arena, _) in
    ...
    let nodes: [Syntax?] = [Syntax(unexpectedBeforeQuestionOrExclamationMark), Syntax(questionOrExclamationMark), Syntax(unexpectedAfterQuestionOrExclamationMark)]
    Syntax(self).setSyntaxTrackingOfTree(SyntaxTracking(tracking: nodes))
  }
...
public struct KeyPathPropertyComponentSyntax: SyntaxProtocol, SyntaxHashable, _LeafSyntaxNodeProtocol {
  ...
  public init(
    ...
    // before they can be added as children of the new arena.
    self = withExtendedLifetime((SyntaxArena(), (
            Syntax(unexpectedBeforeDeclName), 
            Syntax(declName), 
            Syntax(unexpectedBetweenDeclNameAndGenericArgumentClause), 
...
public struct LabeledExprSyntax: SyntaxProtocol, SyntaxHashable, _LeafSyntaxNodeProtocol {
  ...
  public init(
    ...
    self = withExtendedLifetime((SyntaxArena(), (
            ...
            Syntax(colon), 
            Syntax(unexpectedBetweenColonAndExpression), 
            Syntax(expression), 
...
public struct LabeledStmtSyntax: StmtSyntaxProtocol, SyntaxHashable, _LeafStmtSyntaxNodeProtocol {
  ...
  public init(
    ...
    self = withExtendedLifetime((SyntaxArena(), (
            ...
            Syntax(unexpectedBetweenLabelAndColon), 
            Syntax(colon), 
            Syntax(unexpectedBetweenColonAndStatement), 
            Syntax(statement), 
            Syntax(unexpectedAfterStatement)
          ))) { (arena, _) in
      let layout: [RawSyntax?] = [
          unexpectedBeforeLabel?.raw, 
          label.raw, 
...
public struct LayoutRequirementSyntax: SyntaxProtocol, SyntaxHashable, _LeafSyntaxNodeProtocol {
  ...
  public init(
    ...
    self = withExtendedLifetime((SyntaxArena(), (
            ...
            Syntax(type), 
            Syntax(unexpectedBetweenTypeAndColon), 
            Syntax(colon), 
            Syntax(unexpectedBetweenColonAndLayoutSpecifier), 
            Syntax(layoutSpecifier), 
            Syntax(unexpectedBetweenLayoutSpecifierAndLeftParen), 
            Syntax(leftParen), 
            Syntax(unexpectedBetweenLeftParenAndSize), 
            Syntax(size), 
            Syntax(unexpectedBetweenSizeAndComma), 
            Syntax(comma), 
            Syntax(unexpectedBetweenCommaAndAlignment), 
            Syntax(alignment), 
            Syntax(unexpectedBetweenAlignmentAndRightParen), 
            Syntax(rightParen), 
...
public struct MacroDeclSyntax: DeclSyntaxProtocol, SyntaxHashable, _LeafDeclSyntaxNodeProtocol {
  ...
  public init(
    ...
    self = withExtendedLifetime((SyntaxArena(), (
            ...
            Syntax(modifiers), 
            Syntax(unexpectedBetweenModifiersAndMacroKeyword), 
            Syntax(macroKeyword), 
            ...
            Syntax(signature), 
            Syntax(unexpectedBetweenSignatureAndDefinition), 
            Syntax(definition), 
...
public struct MacroExpansionDeclSyntax: DeclSyntaxProtocol, SyntaxHashable, _LeafDeclSyntaxNodeProtocol {
  ...
  public init(
    ...
    self = withExtendedLifetime((SyntaxArena(), (
            ...
            Syntax(unexpectedBetweenAttributesAndModifiers), 
            Syntax(modifiers), 
            Syntax(unexpectedBetweenModifiersAndPound), 
            Syntax(pound), 
            Syntax(unexpectedBetweenPoundAndMacroName), 
            Syntax(macroName), 
            Syntax(unexpectedBetweenMacroNameAndGenericArgumentClause), 
            Syntax(genericArgumentClause), 
            Syntax(unexpectedBetweenGenericArgumentClauseAndLeftParen), 
            Syntax(leftParen), 
...
public struct MemberAccessExprSyntax: ExprSyntaxProtocol, SyntaxHashable, _LeafExprSyntaxNodeProtocol {
  ...
  public init(
    ...
    self = withExtendedLifetime((SyntaxArena(), (
            ...
            Syntax(base), 
            Syntax(unexpectedBetweenBaseAndPeriod), 
            Syntax(period), 
            Syntax(unexpectedBetweenPeriodAndDeclName), 
            Syntax(declName), 
...
public struct MemberBlockItemSyntax: SyntaxProtocol, SyntaxHashable, _LeafSyntaxNodeProtocol {
  ...
  public init(
    ...
    // before they can be added as children of the new arena.
    self = withExtendedLifetime((SyntaxArena(), (
            Syntax(unexpectedBeforeDecl), 
            Syntax(decl), 
            Syntax(unexpectedBetweenDeclAndSemicolon), 
            Syntax(semicolon), 
...
public struct MemberBlockSyntax: SyntaxProtocol, SyntaxHashable, _LeafSyntaxNodeProtocol {
  ...
  public init(
    ...
    self = withExtendedLifetime((SyntaxArena(), (
            ...
            Syntax(leftBrace), 
            Syntax(unexpectedBetweenLeftBraceAndMembers), 
            Syntax(members), 
            Syntax(unexpectedBetweenMembersAndRightBrace), 
            Syntax(rightBrace), 
...
public struct MemberTypeSyntax: TypeSyntaxProtocol, SyntaxHashable, _LeafTypeSyntaxNodeProtocol {
  ...
  public init(
    ...
    // before they can be added as children of the new arena.
    self = withExtendedLifetime((SyntaxArena(), (
            Syntax(unexpectedBeforeBaseType), 
            Syntax(baseType), 
            Syntax(unexpectedBetweenBaseTypeAndPeriod), 
            Syntax(period), 
            Syntax(unexpectedBetweenPeriodAndName), 
            Syntax(name), 
...
public struct MetatypeTypeSyntax: TypeSyntaxProtocol, SyntaxHashable, _LeafTypeSyntaxNodeProtocol {
  ...
  public init(
    ...
    self = withExtendedLifetime((SyntaxArena(), (
            ...
            Syntax(unexpectedBetweenBaseTypeAndPeriod), 
            Syntax(period), 
            Syntax(unexpectedBetweenPeriodAndMetatypeSpecifier), 
            Syntax(metatypeSpecifier), 
            Syntax(unexpectedAfterMetatypeSpecifier)
          ))) { (arena, _) in
      let layout: [RawSyntax?] = [
          unexpectedBeforeBaseType?.raw, 
          baseType.raw, 
...
public struct MultipleTrailingClosureElementSyntax: SyntaxProtocol, SyntaxHashable, _LeafSyntaxNodeProtocol {
  ...
  public init(
    ...
    self = withExtendedLifetime((SyntaxArena(), (
            ...
            Syntax(unexpectedBetweenLabelAndColon), 
            Syntax(colon), 
            Syntax(unexpectedBetweenColonAndClosure), 
            Syntax(closure), 
            Syntax(unexpectedAfterClosure)
          ))) { (arena, _) in
      let layout: [RawSyntax?] = [
          unexpectedBeforeLabel?.raw, 
          label.raw, 
...
public struct NamedOpaqueReturnTypeSyntax: TypeSyntaxProtocol, SyntaxHashable, _LeafTypeSyntaxNodeProtocol {
  ...
  public init(
    ...
    // before they can be added as children of the new arena.
    self = withExtendedLifetime((SyntaxArena(), (
            Syntax(unexpectedBeforeGenericParameterClause), 
            Syntax(genericParameterClause), 
            Syntax(unexpectedBetweenGenericParameterClauseAndType), 
            Syntax(type), 
...
public struct NilLiteralExprSyntax: ExprSyntaxProtocol, SyntaxHashable, _LeafExprSyntaxNodeProtocol {
  ...
  public init(
    ...
    // Extend the lifetime of all parameters so their arenas don't get destroyed
    // before they can be added as children of the new arena.
    self = withExtendedLifetime((SyntaxArena(), (Syntax(unexpectedBeforeNilKeyword), Syntax(nilKeyword), Syntax(unexpectedAfterNilKeyword)))) { (arena, _) in
    ...
    let nodes: [Syntax?] = [Syntax(unexpectedBeforeNilKeyword), Syntax(nilKeyword), Syntax(unexpectedAfterNilKeyword)]
    Syntax(self).setSyntaxTrackingOfTree(SyntaxTracking(tracking: nodes))
  }
