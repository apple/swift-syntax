...
public struct EditorPlaceholderDeclSyntax: DeclSyntaxProtocol, SyntaxHashable, _LeafDeclSyntaxNodeProtocol {
  ...
  public init(
    ...
    self = withExtendedLifetime((SyntaxArena(), (
            ...
            Syntax(modifiers), 
            Syntax(unexpectedBetweenModifiersAndPlaceholder), 
            Syntax(placeholder), 
            Syntax(unexpectedAfterPlaceholder)
          ))) { (arena, _) in
...
public struct EditorPlaceholderExprSyntax: ExprSyntaxProtocol, SyntaxHashable, _LeafExprSyntaxNodeProtocol {
  ...
  public init(
    ...
    // Extend the lifetime of all parameters so their arenas don't get destroyed
    // before they can be added as children of the new arena.
    self = withExtendedLifetime((SyntaxArena(), (Syntax(unexpectedBeforePlaceholder), Syntax(placeholder), Syntax(unexpectedAfterPlaceholder)))) { (arena, _) in
    ...
    let nodes: [Syntax?] = [Syntax(unexpectedBeforePlaceholder), Syntax(placeholder), Syntax(unexpectedAfterPlaceholder)]
    Syntax(self).setSyntaxTrackingOfTree(SyntaxTracking(tracking: nodes))
  }
...
// MARK: - EditorPlaceholderPatternSyntax
...
/// 
///  - `placeholder`: `<identifier>`
public struct EditorPlaceholderPatternSyntax: PatternSyntaxProtocol, SyntaxHashable, _LeafPatternSyntaxNodeProtocol {
  public let _syntaxNode: Syntax
  
  public init?(_ node: some SyntaxProtocol) {
    guard node.raw.kind == .editorPlaceholderPattern else {
      return nil
    }
    self._syntaxNode = node._syntaxNode
  }
  ...
  public init(
    ...
    self = withExtendedLifetime((SyntaxArena(), (Syntax(unexpectedBeforePlaceholder), Syntax(placeholder), Syntax(unexpectedAfterPlaceholder)))) { (arena, _) in
      let layout: [RawSyntax?] = [unexpectedBeforePlaceholder?.raw, placeholder.raw, unexpectedAfterPlaceholder?.raw]
      let raw = RawSyntax.makeLayout(
        kind: SyntaxKind.editorPlaceholderPattern,
        from: layout,
        arena: arena,
        leadingTrivia: leadingTrivia,
        trailingTrivia: trailingTrivia
  ...
  public var unexpectedBeforePlaceholder: UnexpectedNodesSyntax? {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 0, with: Syntax(value), arena: SyntaxArena()).cast(EditorPlaceholderPatternSyntax.self)
    }
  }
  ...
  public var placeholder: TokenSyntax {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 1, with: Syntax(value), arena: SyntaxArena()).cast(EditorPlaceholderPatternSyntax.self)
    }
  }
  ...
  public var unexpectedAfterPlaceholder: UnexpectedNodesSyntax? {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 2, with: Syntax(value), arena: SyntaxArena()).cast(EditorPlaceholderPatternSyntax.self)
    }
  }
...
// MARK: - EditorPlaceholderTypeSyntax
...
public struct EditorPlaceholderTypeSyntax: TypeSyntaxProtocol, SyntaxHashable, _LeafTypeSyntaxNodeProtocol {
  public let _syntaxNode: Syntax
  
  public init?(_ node: some SyntaxProtocol) {
    guard node.raw.kind == .editorPlaceholderType else {
      return nil
    }
    self._syntaxNode = node._syntaxNode
  }
  ...
  ///   - leadingTrivia: Trivia to be prepended to the leading trivia of the node’s first token. If the node is empty, there is no token to attach the trivia to and the parameter is ignored.
  ///   - placeholder: The actual editor placeholder that starts with `<#` and ends with `#>`.
  ///   - genericArgumentClause: Generic arguments that is attatched to the type.
  ///   - trailingTrivia: Trivia to be appended to the trailing trivia of the node’s last token. If the node is empty, there is no token to attach the trivia to and the parameter is ignored.
  public init(
      leadingTrivia: Trivia? = nil,
      _ unexpectedBeforePlaceholder: UnexpectedNodesSyntax? = nil,
      placeholder: TokenSyntax,
      _ unexpectedBetweenPlaceholderAndGenericArgumentClause: UnexpectedNodesSyntax? = nil,
    ...
    // before they can be added as children of the new arena.
    self = withExtendedLifetime((SyntaxArena(), (
            Syntax(unexpectedBeforePlaceholder), 
            Syntax(placeholder), 
            Syntax(unexpectedBetweenPlaceholderAndGenericArgumentClause), 
            Syntax(genericArgumentClause), 
            Syntax(unexpectedAfterGenericArgumentClause)
          ))) { (arena, _) in
      let layout: [RawSyntax?] = [
          unexpectedBeforePlaceholder?.raw, 
          placeholder.raw, 
          unexpectedBetweenPlaceholderAndGenericArgumentClause?.raw, 
          genericArgumentClause?.raw, 
          unexpectedAfterGenericArgumentClause?.raw
        ]
      let raw = RawSyntax.makeLayout(
        kind: SyntaxKind.editorPlaceholderType,
        from: layout,
        arena: arena,
        leadingTrivia: leadingTrivia,
        trailingTrivia: trailingTrivia
  ...
  public var unexpectedBeforePlaceholder: UnexpectedNodesSyntax? {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 0, with: Syntax(value), arena: SyntaxArena()).cast(EditorPlaceholderTypeSyntax.self)
    }
  }
  ...
  public var placeholder: TokenSyntax {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 1, with: Syntax(value), arena: SyntaxArena()).cast(EditorPlaceholderTypeSyntax.self)
    }
  }
  
  public var unexpectedBetweenPlaceholderAndGenericArgumentClause: UnexpectedNodesSyntax? {
    get {
      return Syntax(self).child(at: 2)?.cast(UnexpectedNodesSyntax.self)
    }
    set(value) {
      self = Syntax(self).replacingChild(at: 2, with: Syntax(value), arena: SyntaxArena()).cast(EditorPlaceholderTypeSyntax.self)
    }
  }
  
  /// Generic arguments that is attatched to the type.
  public var genericArgumentClause: GenericArgumentClauseSyntax? {
    get {
      return Syntax(self).child(at: 3)?.cast(GenericArgumentClauseSyntax.self)
    }
    set(value) {
      self = Syntax(self).replacingChild(at: 3, with: Syntax(value), arena: SyntaxArena()).cast(EditorPlaceholderTypeSyntax.self)
    }
  }
  ...
  public var unexpectedAfterGenericArgumentClause: UnexpectedNodesSyntax? {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 4, with: Syntax(value), arena: SyntaxArena()).cast(EditorPlaceholderTypeSyntax.self)
    }
  }
  
  public static var structure: SyntaxNodeStructure {
    return .layout([
          \Self.unexpectedBeforePlaceholder, 
          \Self.placeholder, 
          \Self.unexpectedBetweenPlaceholderAndGenericArgumentClause, 
...
public struct EnumCaseDeclSyntax: DeclSyntaxProtocol, SyntaxHashable, _LeafDeclSyntaxNodeProtocol {
  ...
  public init(
    ...
    self = withExtendedLifetime((SyntaxArena(), (
            ...
            Syntax(unexpectedBetweenAttributesAndModifiers), 
            Syntax(modifiers), 
            Syntax(unexpectedBetweenModifiersAndCaseKeyword), 
            Syntax(caseKeyword), 
            Syntax(unexpectedBetweenCaseKeywordAndElements), 
            Syntax(elements), 
...
public struct EnumCaseElementSyntax: SyntaxProtocol, SyntaxHashable, _LeafSyntaxNodeProtocol {
  ...
  public init(
    ...
    self = withExtendedLifetime((SyntaxArena(), (
            ...
            Syntax(name), 
            Syntax(unexpectedBetweenNameAndParameterClause), 
            Syntax(parameterClause), 
            Syntax(unexpectedBetweenParameterClauseAndRawValue), 
            Syntax(rawValue), 
            Syntax(unexpectedBetweenRawValueAndTrailingComma), 
...
public struct EnumCaseParameterSyntax: SyntaxProtocol, SyntaxHashable, _LeafSyntaxNodeProtocol {
  ...
  public init(
    ...
    // before they can be added as children of the new arena.
    self = withExtendedLifetime((SyntaxArena(), (
            Syntax(unexpectedBeforeModifiers), 
            Syntax(modifiers), 
            ...
            Syntax(type), 
            Syntax(unexpectedBetweenTypeAndDefaultValue), 
            Syntax(defaultValue), 
            Syntax(unexpectedBetweenDefaultValueAndTrailingComma), 
            Syntax(trailingComma), 
            Syntax(unexpectedAfterTrailingComma)
          ))) { (arena, _) in
      let layout: [RawSyntax?] = [
...
public struct EnumDeclSyntax: DeclSyntaxProtocol, SyntaxHashable, _LeafDeclSyntaxNodeProtocol {
  ...
  public init(
    ...
    self = withExtendedLifetime((SyntaxArena(), (
            ...
            Syntax(unexpectedBetweenAttributesAndModifiers), 
            Syntax(modifiers), 
            Syntax(unexpectedBetweenModifiersAndEnumKeyword), 
            Syntax(enumKeyword), 
            Syntax(unexpectedBetweenEnumKeywordAndName), 
            Syntax(name), 
...
public struct ExposeAttributeArgumentsSyntax: SyntaxProtocol, SyntaxHashable, _LeafSyntaxNodeProtocol {
  ...
  public init(
    ...
    // before they can be added as children of the new arena.
    self = withExtendedLifetime((SyntaxArena(), (
            Syntax(unexpectedBeforeLanguage), 
            Syntax(language), 
            Syntax(unexpectedBetweenLanguageAndComma), 
            Syntax(comma), 
            Syntax(unexpectedBetweenCommaAndCxxName), 
            Syntax(cxxName), 
            Syntax(unexpectedAfterCxxName)
          ))) { (arena, _) in
      let layout: [RawSyntax?] = [
...
public struct ExpressionPatternSyntax: PatternSyntaxProtocol, SyntaxHashable, _LeafPatternSyntaxNodeProtocol {
  ...
  public init(
    ...
    // Extend the lifetime of all parameters so their arenas don't get destroyed
    // before they can be added as children of the new arena.
    self = withExtendedLifetime((SyntaxArena(), (Syntax(unexpectedBeforeExpression), Syntax(expression), Syntax(unexpectedAfterExpression)))) { (arena, _) in
    ...
    let nodes: [Syntax?] = [Syntax(unexpectedBeforeExpression), Syntax(expression), Syntax(unexpectedAfterExpression)]
    Syntax(self).setSyntaxTrackingOfTree(SyntaxTracking(tracking: nodes))
  }
...
public struct ExpressionSegmentSyntax: SyntaxProtocol, SyntaxHashable, _LeafSyntaxNodeProtocol {
  ...
  public init(
    ...
    // before they can be added as children of the new arena.
    self = withExtendedLifetime((SyntaxArena(), (
            Syntax(unexpectedBeforeBackslash), 
            Syntax(backslash), 
            Syntax(unexpectedBetweenBackslashAndPounds), 
            Syntax(pounds), 
            Syntax(unexpectedBetweenPoundsAndLeftParen), 
            Syntax(leftParen), 
            Syntax(unexpectedBetweenLeftParenAndExpressions), 
            Syntax(expressions), 
            Syntax(unexpectedBetweenExpressionsAndRightParen), 
            Syntax(rightParen), 
            Syntax(unexpectedAfterRightParen)
          ))) { (arena, _) in
      let layout: [RawSyntax?] = [
...
public struct ExtensionDeclSyntax: DeclSyntaxProtocol, SyntaxHashable, _LeafDeclSyntaxNodeProtocol {
  ...
  public init(
    ...
    self = withExtendedLifetime((SyntaxArena(), (
            ...
            Syntax(unexpectedBetweenAttributesAndModifiers), 
            Syntax(modifiers), 
            Syntax(unexpectedBetweenModifiersAndExtensionKeyword), 
            Syntax(extensionKeyword), 
            Syntax(unexpectedBetweenExtensionKeywordAndExtendedType), 
            Syntax(extendedType), 
            Syntax(unexpectedBetweenExtendedTypeAndInheritanceClause), 
            Syntax(inheritanceClause), 
            Syntax(unexpectedBetweenInheritanceClauseAndGenericWhereClause), 
            Syntax(genericWhereClause), 
            Syntax(unexpectedBetweenGenericWhereClauseAndMemberBlock), 
...
public struct FallThroughStmtSyntax: StmtSyntaxProtocol, SyntaxHashable, _LeafStmtSyntaxNodeProtocol {
  ...
  public init(
    ...
    // Extend the lifetime of all parameters so their arenas don't get destroyed
    // before they can be added as children of the new arena.
    self = withExtendedLifetime((SyntaxArena(), (Syntax(unexpectedBeforeFallthroughKeyword), Syntax(fallthroughKeyword), Syntax(unexpectedAfterFallthroughKeyword)))) { (arena, _) in
    ...
    let nodes: [Syntax?] = [Syntax(unexpectedBeforeFallthroughKeyword), Syntax(fallthroughKeyword), Syntax(unexpectedAfterFallthroughKeyword)]
    Syntax(self).setSyntaxTrackingOfTree(SyntaxTracking(tracking: nodes))
  }
...
public struct FloatLiteralExprSyntax: ExprSyntaxProtocol, SyntaxHashable, _LeafExprSyntaxNodeProtocol {
  ...
  public init(
    ...
    // Extend the lifetime of all parameters so their arenas don't get destroyed
    // before they can be added as children of the new arena.
    self = withExtendedLifetime((SyntaxArena(), (Syntax(unexpectedBeforeLiteral), Syntax(literal), Syntax(unexpectedAfterLiteral)))) { (arena, _) in
...
public struct ForStmtSyntax: StmtSyntaxProtocol, SyntaxHashable, _LeafStmtSyntaxNodeProtocol {
  ...
  public init(
    ...
    // before they can be added as children of the new arena.
    self = withExtendedLifetime((SyntaxArena(), (
            Syntax(unexpectedBeforeForKeyword), 
            Syntax(forKeyword), 
            Syntax(unexpectedBetweenForKeywordAndTryKeyword), 
            Syntax(tryKeyword), 
            Syntax(unexpectedBetweenTryKeywordAndAwaitKeyword), 
            Syntax(awaitKeyword), 
            Syntax(unexpectedBetweenAwaitKeywordAndCaseKeyword), 
            Syntax(caseKeyword), 
            Syntax(unexpectedBetweenCaseKeywordAndPattern), 
            Syntax(pattern), 
            Syntax(unexpectedBetweenPatternAndTypeAnnotation), 
            Syntax(typeAnnotation), 
            Syntax(unexpectedBetweenTypeAnnotationAndInKeyword), 
            Syntax(inKeyword), 
            Syntax(unexpectedBetweenInKeywordAndSequence), 
            Syntax(sequence), 
            Syntax(unexpectedBetweenSequenceAndWhereClause), 
            Syntax(whereClause), 
            Syntax(unexpectedBetweenWhereClauseAndBody), 
            Syntax(body), 
...
public struct ForceUnwrapExprSyntax: ExprSyntaxProtocol, SyntaxHashable, _LeafExprSyntaxNodeProtocol {
  ...
  public init(
    ...
    self = withExtendedLifetime((SyntaxArena(), (
            ...
            Syntax(expression), 
            Syntax(unexpectedBetweenExpressionAndExclamationMark), 
...
public struct FunctionCallExprSyntax: ExprSyntaxProtocol, SyntaxHashable, _LeafExprSyntaxNodeProtocol {
  ...
  public init(
    ...
    self = withExtendedLifetime((SyntaxArena(), (
            ...
            Syntax(calledExpression), 
            Syntax(unexpectedBetweenCalledExpressionAndLeftParen), 
            Syntax(leftParen), 
            Syntax(unexpectedBetweenLeftParenAndArguments), 
            Syntax(arguments), 
            Syntax(unexpectedBetweenArgumentsAndRightParen), 
            Syntax(rightParen), 
            Syntax(unexpectedBetweenRightParenAndTrailingClosure), 
            Syntax(trailingClosure), 
            Syntax(unexpectedBetweenTrailingClosureAndAdditionalTrailingClosures), 
            Syntax(additionalTrailingClosures), 
            Syntax(unexpectedAfterAdditionalTrailingClosures)
          ))) { (arena, _) in
      let layout: [RawSyntax?] = [
...
public struct FunctionDeclSyntax: DeclSyntaxProtocol, SyntaxHashable, _LeafDeclSyntaxNodeProtocol {
  ...
  public init(
    ...
    self = withExtendedLifetime((SyntaxArena(), (
            ...
            Syntax(unexpectedBetweenAttributesAndModifiers), 
            Syntax(modifiers), 
            Syntax(unexpectedBetweenModifiersAndFuncKeyword), 
            Syntax(funcKeyword), 
            Syntax(unexpectedBetweenFuncKeywordAndName), 
            Syntax(name), 
            Syntax(unexpectedBetweenNameAndGenericParameterClause), 
            Syntax(genericParameterClause), 
...
public struct FunctionEffectSpecifiersSyntax: SyntaxProtocol, SyntaxHashable, _LeafSyntaxNodeProtocol {
  ...
  public init(
    ...
    self = withExtendedLifetime((SyntaxArena(), (
            ...
            Syntax(unexpectedBetweenAsyncSpecifierAndThrowsSpecifier), 
...
public struct FunctionParameterSyntax: SyntaxProtocol, SyntaxHashable, _LeafSyntaxNodeProtocol {
  ...
  public init(
    ...
    self = withExtendedLifetime((SyntaxArena(), (
            ...
            Syntax(ellipsis), 
            Syntax(unexpectedBetweenEllipsisAndDefaultValue), 
            Syntax(defaultValue), 
            Syntax(unexpectedBetweenDefaultValueAndTrailingComma), 
            Syntax(trailingComma), 
            Syntax(unexpectedAfterTrailingComma)
...
public struct FunctionSignatureSyntax: SyntaxProtocol, SyntaxHashable, _LeafSyntaxNodeProtocol {
  ...
  public init(
    ...
    // before they can be added as children of the new arena.
    self = withExtendedLifetime((SyntaxArena(), (
            Syntax(unexpectedBeforeParameterClause), 
            Syntax(parameterClause), 
            ...
            Syntax(returnClause), 
            Syntax(unexpectedAfterReturnClause)
          ))) { (arena, _) in
      let layout: [RawSyntax?] = [
...
public struct FunctionTypeSyntax: TypeSyntaxProtocol, SyntaxHashable, _LeafTypeSyntaxNodeProtocol {
  ...
  public init(
    ...
    self = withExtendedLifetime((SyntaxArena(), (
            ...
            Syntax(unexpectedBetweenParametersAndRightParen), 
            Syntax(rightParen), 
            Syntax(unexpectedBetweenRightParenAndEffectSpecifiers), 
            Syntax(effectSpecifiers), 
            Syntax(unexpectedBetweenEffectSpecifiersAndReturnClause), 
            Syntax(returnClause), 
            Syntax(unexpectedAfterReturnClause)
